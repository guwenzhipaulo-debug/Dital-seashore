...
float phaseTimer = 0;
float inhaleDur = 3.8f;   // slower breathing (seconds)
float exhaleDur = 3.8f;   // slower breathing (seconds)
int prevMillis = 0;
...
String[] quotes = {
  ...
  "\"The best thing one can do when it is raining is to let it rain.\" - Henry Wadsworth Longfellow (1863)",
  "\"I lean and loafe at my ease observing a spear of summer grass.\" - Walt Whitman (1855)",
  "\"Let me not pray for shelter from danger, but for courage in facing it.\" - Rabindranath Tagore, Gitanjali (1912)",
  ...
  "\"The woods are lovely, dark and deep.\" - Robert Frost (1923)"
};
